...
const Navbar: React.FC = () => {
  const { state, toggleDarkMode, setActiveFeatureId } = useAppState(); // Destructure setActiveFeatureId
    ...
    <nav className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 py-3">
      <div className="container mx-auto px-4 flex justify-between items-center">
        <div className="font-bold text-gray-800 dark:text-gray-200 flex items-center gap-4">
          ...
          <a
            href="#"
            onClick={() => setActiveFeatureId('crm')} // Set activeFeatureId to 'crm' on click
            className="text-blue-500 hover:text-blue-700 font-bold text-lg px-3 py-1 rounded-md bg-blue-100 dark:bg-blue-900" // Highlighted styles
          >
            CRM
          </a>
        </div>
