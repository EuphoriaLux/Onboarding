...
/**
 * Clipboard Service
 * Utilities for copying content to clipboard with enhanced formatting
 */
 ...
 * 
 * @param html - HTML with script blocks
 * @returns HTML with enhanced script formatting
 */
...
/**
 * Copy content to clipboard with format detection
 * Will try rich text first, then fall back to plain text
 * 
 * @param html - HTML content to copy
