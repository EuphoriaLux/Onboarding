...
const AuthorizedContactsSidebar: React.FC<AuthorizedContactsSidebarProps> = ({ contacts, selectedCustomerId, onAddContactClick, customerName }) => {
  return (
    <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-lg lg:sticky lg:top-[calc(theme(spacing.6)_+_250px)]"> {/* Adjust top based on CustomerContactSidebar height */}
